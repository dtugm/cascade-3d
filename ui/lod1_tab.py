...
class LOD1TabWidget(QtWidgets.QWidget):
    def __init__(self, type, parent=None):
        ...
        self.result = DirectoryInputComponent(
            "Output Directory",
            button_font_color="white",
            defaultValue=os.path.join(get_base_dir(), "Cascade 3D", "output", "lod1")
        )
        ...
        self.button = Button("Generate LOD 1")
    ...
    def on_button_clicked(self):   
        ...
        # worker object
        self.worker = GenerateLOD1(config)
        # worker to thread
